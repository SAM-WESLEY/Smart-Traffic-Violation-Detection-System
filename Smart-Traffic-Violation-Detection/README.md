...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/EasyOCR-NumberPlate-orange?style=for-the-badge"/>
...
Smart Traffic Violation Detection System is a complete computer vision pipeline for intelligent traffic surveillance. It processes live camera feeds or video files to detect three types of violations simultaneously — saving violation snapshots, reading number plates, and logging all incidents to a web dashboard in real time.

---

## 🚦 Features

- 🚦 **Red Light Violation Detection** — detects vehicles crossing the stop line during red signal
...
- 🗃️ **Violation Database** — all incidents stored with plate number, type, timestamp
...
[Traffic Camera / Video File]
         ↓
[Smart Traffic Violation Detection System]
    ├── Red Light Module    → Detects signal state + stop line crossing
    ├── Helmet Module       → YOLOv8 — detects helmet / no-helmet
...
|---|---|---|
| Red Light Jumping | HSV Signal + Stop Line | ~92% |
| No Helmet | YOLOv8 Classification | ~94% |
...
│   └── violation_logger.py        # SQLite violation database logger
├── dashboard/
...
╠══════╬══════════════╬═══════════════╬══════════════════════╣
║  001 ║  TN 09 AB 1234║ Red Light    ║  2025-03-15 09:14:32 ║
║  002 ║  MH 12 CD 5678║ No Helmet    ║  2025-03-15 09:15:10 ║
║  003 ║  KA 05 EF 9012║ Red Light    ║  2025-03-15 09:16:45 ║
╚══════╩══════════════╩═══════════════╩══════════════════════╝
```
